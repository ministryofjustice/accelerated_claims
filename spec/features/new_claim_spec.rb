...
feature "New claim application", js: true do
  context "with two claimants" do
    scenario "fill in claim details" do
      visit '/new'
      fill_property_details_js
      fill_claimant_one_js
      fill_claimant_solicitor_address_js
      fill_claimant_contact_details_js
      fill_claimant_contact_reference_js
      fill_claimant_two
      fill_defendant_one
      fill_solicitor_cost
      fill_demoted_tenancy
