    ...
    context 'timely lookup' do
      it 'should call ideal-postcodes and return true, transforming the api into @result_set' do
        ...
        expect(pclp.result_set).to eq [
          {'address'=>'2 Barons Court Road;;LONDON', 'postcode'=>'ID1 1QD', 'country' => 'England'}, 
          {'address'=>'Basement Flat;;2 Barons Court Road;;LONDON', 'postcode'=>'ID1 1QD', 'country' => 'England'}
        ]
      end
    end
  ...
  describe 'private method transform_api_address' do
    context 'lines 2 and 3 blank' do
      it 'should return simple first line and postcode' do
        ...
        expect(transformed).to eq({'address' => '2 Barons Court Road;;LONDON', 'postcode' => 'ID1 1QD', 'country' => 'England' })
      end
    end

    context '3 line address' do
      it 'should return a 3-line address' do
        pclp = PostcodeLookupProxy.new('id1 1qd', ['England', 'Wales'] )
        transformed = pclp.send(:transform_api_address, three_line_address)
        expect(transformed).to eq({'address' => 'Basement Flat;;Dunroamin;;5 Barons Court Road;;LONDON', 'postcode' => 'ID1 1QD', 'country' => 'England' })
      end
    end
  end
