...
def base_errors
  [
    ...
    ["claim_claimant_1_full_name_error",              "Enter the claimant's full name"],
    ["claim_claimant_1_street_error",                 "Enter the claimant's full address"],
    ["claim_claimant_1_postcode_error",               "Enter the claimant's postcode"],
