...
describe ErrorMessageSequencer do
  ...
  let(:claim_defendant_1_inhabits_property_error)                                 { ['claim_defendant_1_inhabits_property_error',     'msg']}
  let(:claim_defendant_1_title_error)                                             { ['claim_defendant_1_title_error',                 'msg']}
  let(:claim_defendant_1_full_name_error)                                         { ['claim_defendant_1_full_name_error',             'msg']}
  let(:claim_defendant_1_street_error)                                            { ['claim_defendant_1_street_error',                'msg']}
  let(:claim_defendant_1_postcode_error)                                          { ['claim_defendant_1_postcode_error',              'msg']}
  let(:claim_defendant_5_inhabits_property_error)                                 { ['claim_defendant_5_inhabits_property_error',     'msg']}
  let(:claim_defendant_5_title_error)                                             { ['claim_defendant_8_full_name_error',             'msg']}
  let(:claim_defendant_8_full_name_error)                                         { ['claim_defendant_8_full_name_error',             'msg']}
  let(:claim_defendant_8_street_error)                                            { ['claim_defendant_8_street_error',                'msg']}
  let(:claim_defendant_18_postcode_error)                                         { ['claim_defendant_18_postcode_error',             'msg']}
  ...
  let(:base_errors) do
    [
      ...
      claim_defendant_18_postcode_error,
      claim_defendant_8_full_name_error,
      claim_defendant_5_inhabits_property_error,
      claim_defendant_5_title_error,
      claim_defendant_8_street_error,
