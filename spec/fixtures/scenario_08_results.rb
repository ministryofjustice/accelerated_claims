{
  ...
  NameOfCourt: nil,
  ClaimNumber: nil,
  claimant_one_address: "Mrs Shirley Williams\n38 Llanwrchgog St\nCaedffyn",
  claimant_one_postcode1: "GO31",
  claimant_one_postcode2: "1RJ",
  claimant_two_address: nil,
  claimant_two_postcode1: nil,
  claimant_two_postcode2: nil,
  defendant_one_address: "Mr Organ Morgan\nUnit 11,\nWelsh Wood Park,\nGooselake",
  defendant_one_postcode1: "GO5",
  defendant_one_postcode2: "4BB",
  defendant_two_address: "Mr Owen Alott\nUnit 11,\nWelsh Wood Park,\nGooselake",
  defendant_two_postcode1: "GO5",
