# coding: utf-8
{
  ...
  claim_license_issued_under_act_part_applied: [
    "Issued under act part applied",
    "Licence for properties that are within an area defined by a local council (issued under part 3 of the Housing act 2004)"
  ],
