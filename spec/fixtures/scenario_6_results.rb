{
  Button94: nil,
  Button95: nil,
  claimant_one_address: "Affinity Sutton\nMaple House, 157-159 Masons Hall\nLondon",
  claimant_one_postcode1: "BR2",
  ...
  claimant_contact_email: "amyturner@affinitysutton.co.uk",
