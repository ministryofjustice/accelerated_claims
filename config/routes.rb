AcceleratedClaims::Application.routes.draw do
  ...
  scope AcceleratedClaims::Application.config.relative_url_root || '/' do
    ...
    get  '/expired/*all',   controller: :static, action: :expired, as: :expired_all, constraints: { all: /.*/ }
    ...
    post '/expire_session/*all', controller: :application, action: :expire_session, constraints: { all: /.*/ }
