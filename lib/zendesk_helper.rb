module ZendeskHelper
  def self.send_to_zendesk(feedback, client=ZENDESK_CLIENT)
    # This sends the feedback to ZenDesk - the IDs present at the moment relate to Prison Visits, from whence this came.
    # Commented out until a CC sub-project exists
